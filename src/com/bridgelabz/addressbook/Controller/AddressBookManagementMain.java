...
import com.bridgelabz.addressbook.Services.ContactController;
import com.bridgelabz.addressbook.Services.ScannerUtility;

import com.bridgelabz.addressbook.Services.*;
public class AddressBookManagementMain {
	static {
	...
	public static void main(String[] args) {
		...
		UserInterface userInterface = UserInterface.getInstance();
		AddressBookManagementMain main = new AddressBookManagementMain();
